...
class AllocationSale extends StatefulWidget {
  _AllocationSaleState createState() => _AllocationSaleState();
}

class _AllocationSaleState extends State<AllocationSale> {
            ...
            content: Form(
                ...
                child: TextFormField(
                    ...
                    validator: (String quantity) {
                      var quantityAllocated = item["quantity_in_stock"];
                      if (quantity.isEmpty) {
                        return "Please fill in quantity details";
                      }
                      if (double.parse(quantity) >
                          double.parse(quantityAllocated)) {
                        return "Quantity exceeded your allocation.\nPlease select a lower amount.\nYour remaining allocation is ${quantityAllocated.toString()}";
                      }
                    })),
            actions: [
              RaisedButton(
  ...
  Widget build(BuildContext context) {
    var request = {
      ...
      "data": {"type_of_sale": 2, "user_id": this._userId}
    };
    return Scaffold(
        body: FutureBuilder(
